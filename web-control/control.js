     ...
     // $('#log').val("speedA:" + speedA+ "\t pasosA:" + stepsA+ "\t speedB:" +speedB+ "\t pasosB:" + stepsB +"\n"+ $('#log').val());
      ...
      $.ajax({
        ...
        error: function (objeto, quepaso, otroobj) {
          ...
          $('#errores').val("No se pudo completar la operacion: " + quepaso +"\n"+ $('#errores').val());
        },
        success: function (datos) {
          if (datos.result_ok) {
            $('#log').val( JSON.stringify(params)+ " "+JSON.stringify(datos)+ "\n"+  $('#log').val());
          } else {
  ...
  function command(comando) {
    ...
    //  $('#log').val(comando+"..." + "\n"+ $('#log').val());
      ...
      $.ajax({
        ...
        dataType: "json",
        error: function (objeto, quepaso, otroobj) {
          console.log("No se pudo completar la operacion "+comando+": " + quepaso);
          $('#errores').val("No se pudo completar la operacion "+comando+": " + quepaso +"\n"+ $('#errores').val());
        },
        success: function (datos) {
          if (datos.result_ok) {
            $('#log').val(comando+"... " +JSON.stringify(datos)+" \n"+ $('#log').val());
          } else {
            alert(datos.desc_error);
          }
        },
